...
{
    [HelpURL("https://stackoverflow.com/questions/23535304/getting-the-width-of-a-sprite")]
    public static class SpritePixelSize
    {
        public static Vector2 Get(SpriteRenderer spriteRenderer, Camera camera = null)
        {
